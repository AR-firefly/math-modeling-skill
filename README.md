...
> 从 v1 升级到 v2.0 改了什么，见下方「[v1 → v2.0 的变化](#v1--v20-的变化)」或 [CHANGELOG.md](CHANGELOG.md)。
...
├── CHANGELOG.md                   ← 版本更新说明（v1 → v2.0 的变化）
├── LICENSE                        ← AGPL-3.0
...
v1 是「4 个算法示例 + 论文生成框架」，v2.0 扩成了全流程工作流。
...
**v1 保留的部分**：4 个算法示例、论文生成框架（3 个模块）、4 篇方法论文档。

想对照两个版本：`git checkout 4366f0b` 是 v1，`git checkout main` 是最新的 v2.0。完整变更记录见 [CHANGELOG.md](CHANGELOG.md)。
